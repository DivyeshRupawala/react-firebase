	...
	return(
		<div className='login'>		  
	      <Card>	       
	        ...
	        <CardBody>
		      <Form>
		      	<InputWithLabel id='email' label="Email" type="email" onChangeValue={onEmailChangeHandler}/>
		        <InputWithLabel id='password' label="Password" type="password" onChangeValue={onPasswordChangeHandler}/>
